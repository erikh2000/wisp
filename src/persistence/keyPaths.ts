...
export const LOCATION_IMAGES_PATH_TEMPLATE = '/projects/{projectName}/locations/images/';
export const LOCATION_KEY_TEMPLATE = '/projects/{projectName}/locations/{locationName}';
export const LOCATIONS_PATH_TEMPLATE = '/projects/{projectName}/locations/';
