...
import {WordTimeline, WordTimelineExtractor, WordTiming} from 'sl-web-speech';
import {LipzEvent, loadLipzFromText, phonemeToViseme, Viseme} from 'sl-web-face';
...
export type VisemeTimeline = VisemeTiming[];
